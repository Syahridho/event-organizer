...
function DeleteDialog({ building, onDeleteSuccess }) {
...
const columns = [
    ...
    {
        accessorKey: "Harga",
        header: () => <div className="w-full text-start">Harga Perhari</div>,
        cell: ({ row }) => {
            return (
                <div>
                    <p>Rp. {formatRupiah(row.original.price)}</p>
                </div>
            );
        },
    },
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-32">
                            <DropdownMenuItem
                                onClick={() => {
                                    router.get(
                                        `/dashboard/buildings/${building.id}/edit`
                                    );
                                }}
                            >
                                Edit
            ...
            <div className="flex items-center justify-between px-4 lg:px-6">
                <div className="flex items-center justify-between gap-2 w-full">
                    <div className="flex items-center gap-2">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-56">
                                ...
                                >
                                    <div className="flex items-center gap-2">
                                        <CheckCircle2Icon className="h-3 w-3 text-red-500" />
                    ...
                    <Button
                        ...
                        size="sm"
                        onClick={() =>
                            router.visit("/dashboard/buildings/create")
                        }
                    >
                        <PlusIcon />
                        <span className="hidden lg:inline">
